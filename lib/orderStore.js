  ...
  return {
    ...
    async add(o) {
      const r = await pool.query(
        `INSERT INTO orders (customer_name, phone, delivery_method, items, subtotal, tax, total)
         VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING *`,
        [o.customer_name, o.phone, o.delivery_method, JSON.stringify(o.items), o.subtotal, o.tax, o.total]
      );
      return map(r.rows[0]);
    },
